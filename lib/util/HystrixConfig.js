...
var HystrixConfig = (function () {
    ...
    _createClass(HystrixConfig, null, [{
        ...
        value: function init() {
            ...
            if (properties[HystrixPropertiesNames.HYSTRIX_CIRCUIT_ERROR_THRESHOLD_PERCENTAGE]) {
            ...
            if (properties[HystrixPropertiesNames.HYSTRIX_CIRCUIT_SLEEP_WINDOW_IN_MS]) {
            ...
            if (properties[HystrixPropertiesNames.HYSTRIX_CIRCUIT_VOLUME_THRESHOLD]) {
            ...
            if (properties[HystrixPropertiesNames.HYSTRIX_CIRCUIT_VOLUME_THRESHOLD_OVERRIDE]) {
            ...
            if (properties[HystrixPropertiesNames.HYSTRIX_FORCE_OVERRIDE_CIRCUIT_VOLUME_THRESHOLD]) {
            ...
            if (properties[HystrixPropertiesNames.HYSTRIX_EXECUTION_TIMEOUT_IN_MS]) {
            ...
            if (properties[HystrixPropertiesNames.HYSTRIX_FORCE_CIRCUIT_CLOSED]) {
            ...
            if (properties[HystrixPropertiesNames.HYSTRIX_FORCE_CIRCUIT_OPEN]) {
            ...
            if (properties[HystrixPropertiesNames.HYSTRIX_METRICS_PERCENTILE_WINDOW_BUCKETS]) {
            ...
            if (properties[HystrixPropertiesNames.HYSTRIX_METRICS_PERCENTILE_WINDOW_IN_MS]) {
            ...
            if (properties[HystrixPropertiesNames.HYSTRIX_METRICS_STATISTICAL_WINDOW_BUCKETS]) {
            ...
            if (properties[HystrixPropertiesNames.HYSTRIX_METRICS_STATISTICAL_WINDOW_IN_MS]) {
        ...
        get: function get() {
            return customProperties.get(HystrixPropertiesNames.HYSTRIX_METRICS_PERCENTILE_WINDOW_BUCKETS) || environment[HystrixPropertiesNames.HYSTRIX_METRICS_PERCENTILE_WINDOW_BUCKETS];
        }
    }, {
        key: "circuitBreakerForceClosed",
        get: function get() {
            return customProperties.get(HystrixPropertiesNames.HYSTRIX_FORCE_CIRCUIT_CLOSED) || environment[HystrixPropertiesNames.HYSTRIX_FORCE_CIRCUIT_CLOSED];
        }
    }, {
        key: "circuitBreakerForceOpened",
        get: function get() {
            return customProperties.get(HystrixPropertiesNames.HYSTRIX_FORCE_CIRCUIT_OPEN) || environment[HystrixPropertiesNames.HYSTRIX_FORCE_CIRCUIT_OPEN];
        }
    }, {
        key: "circuitBreakerSleepWindowInMilliseconds",
        get: function get() {
            return customProperties.get(HystrixPropertiesNames.HYSTRIX_CIRCUIT_SLEEP_WINDOW_IN_MS) || environment[HystrixPropertiesNames.HYSTRIX_CIRCUIT_SLEEP_WINDOW_IN_MS];
        }
    }, {
        key: "circuitBreakerErrorThresholdPercentage",
        get: function get() {
            return customProperties.get(HystrixPropertiesNames.HYSTRIX_CIRCUIT_ERROR_THRESHOLD_PERCENTAGE) || environment[HystrixPropertiesNames.HYSTRIX_CIRCUIT_ERROR_THRESHOLD_PERCENTAGE];
        }
    }, {
        key: "circuitBreakerRequestVolumeThreshold",
        get: function get() {
            return customProperties.get(HystrixPropertiesNames.HYSTRIX_CIRCUIT_VOLUME_THRESHOLD) || environment[HystrixPropertiesNames.HYSTRIX_CIRCUIT_VOLUME_THRESHOLD];
        }
    }, {
        key: "circuitBreakerRequestVolumeThresholdForceOverride",
        get: function get() {
            return customProperties.get(HystrixPropertiesNames.HYSTRIX_FORCE_OVERRIDE_CIRCUIT_VOLUME_THRESHOLD) || environment[HystrixPropertiesNames.HYSTRIX_FORCE_OVERRIDE_CIRCUIT_VOLUME_THRESHOLD];
        }
    }, {
        key: "circuitBreakerRequestVolumeThresholdOverride",
        get: function get() {
            return customProperties.get(HystrixPropertiesNames.HYSTRIX_CIRCUIT_VOLUME_THRESHOLD_OVERRIDE) || environment[HystrixPropertiesNames.HYSTRIX_CIRCUIT_VOLUME_THRESHOLD_OVERRIDE];
        }
    }, {
        key: "executionTimeoutInMilliseconds",
        get: function get() {
            return customProperties.get(HystrixPropertiesNames.HYSTRIX_EXECUTION_TIMEOUT_IN_MS) || environment[HystrixPropertiesNames.HYSTRIX_EXECUTION_TIMEOUT_IN_MS];
        }
    }, {
        key: "metricsStatisticalWindowBuckets",
        get: function get() {
            return customProperties.get(HystrixPropertiesNames.HYSTRIX_METRICS_STATISTICAL_WINDOW_BUCKETS) || environment[HystrixPropertiesNames.HYSTRIX_METRICS_STATISTICAL_WINDOW_BUCKETS];
        }
    }, {
        key: "metricsStatisticalWindowInMilliseconds",
        get: function get() {
            return customProperties.get(HystrixPropertiesNames.HYSTRIX_METRICS_STATISTICAL_WINDOW_IN_MS) || environment[HystrixPropertiesNames.HYSTRIX_METRICS_STATISTICAL_WINDOW_IN_MS];
        }
    }, {
        key: "metricsPercentileWindowInMilliseconds",
        get: function get() {
            return customProperties.get(HystrixPropertiesNames.HYSTRIX_METRICS_PERCENTILE_WINDOW_IN_MS) || environment[HystrixPropertiesNames.HYSTRIX_METRICS_PERCENTILE_WINDOW_IN_MS];
        }
    }]);
